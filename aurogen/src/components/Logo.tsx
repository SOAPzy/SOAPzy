export default function Logo({ size = 36 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="33.5" cy="20" r="1.2" fill="#F0B429" opacity="0.55" />
      <circle cx="6.5" cy="20" r="1.2" fill="#F0B429" opacity="0.55" />
      <circle cx="32" cy="27" r="1.8" fill="#F0B429" opacity="0.9" />
      <circle cx="8" cy="27" r="1.8" fill="#F0B429" opacity="0.9" />
      <defs>
